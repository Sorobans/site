...
const s_stylePath = '/css/comment-widget.css'; // Define the path for the stylesheet (ie. /styles/commentwidget.css)
const s_formId = '1FAIpQLScv7mUds3NrM4Vfb8u9svoypAxPO5frHfSDke-CZ4HoXfhDog'; // The Google Form
const s_nameId = '1409749469'; // The Name field ID
const s_websiteId = '379314922'; // The Website field ID
const s_textId = '230993507'; // The Text field ID
/* const s_moderatedId = '794720883'; // The Moderated field ID */
const s_pageId = '45803061'; // The Page field ID
const s_replyId = '313255350'; // The Reply field ID
const s_sheetId = '1Fzjb51zZPoVhQJb4v6PuFE8uT4D6lcPVKfE9VfqoWIY'; // The Google Sheet
